...
- [x] 2.2 Implement LLM ordering by stable IDs and typed failure, verifying it never writes a verse or expands the list.

## 3. Verify

- [x] 3.1 Run `npm test` and `npm run build`, verifying V2 selection supports backtracking data.
