...
- [ ] 1.1 Add failing acceptance tests with orthographically similar words that the approved catalog deliberately separates, verifying `inspect-rhymes` never invents candidates.
- [ ] 1.2 Add failing tests for analysis/catalog inconsistency and excluded doubtful members, verifying both keys and exclusion evidence are preserved.
